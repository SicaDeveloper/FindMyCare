...
// Minimal OpenAPI 3.0 document scaffold. Extend as needed or generate programmatically later.
const openapi = {
  openapi: '3.0.3',
  info: {
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['name','email','password','phone','gender','panNumber','dateOfBirth','citizenship','experience'],
                properties: {
                  ...
                  citizenship: {
                    ...
                    properties: {
                      number: { type: 'string', example: '01-01-00012345' },
                      issuedDate: { type: 'string', format: 'date', example: '2010-01-31' },
                      frontPath: { type: 'string', description: 'Base64 or URL to front image' },
                      backPath: { type: 'string', description: 'Base64 or URL to back image' }
                    }
                  },
                  experience: { type: 'integer', format: 'int32', example: 5 },
